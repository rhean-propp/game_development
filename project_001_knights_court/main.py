...
def prologue():
    ...
    delay_print("You can begin to hear the solemn verses of the ceremony sung in the verslexic tongue.\n")
    ...
    delay_print("As you look up, you can see the teary eyed choir, as they sing what that which they hope to be their last ceremonial song.\n")
